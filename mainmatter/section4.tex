...
Their priors used on each of these parameters are shown in table~\ref{tab:sim_params}. \red{Add 2018 Planck estimates here instead?}.

All other parameters of the flat $\Lambda$CDM cosmology are fixed to the Planck measurements. This means Ωb = 0.04897, $\sigma_8$ = 0.8102, h= 0.6766, and
ns
= 0.9665.  
