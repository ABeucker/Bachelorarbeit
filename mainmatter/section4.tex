...
\red{Should I clarify dense layers, affine coupling layers?}
...
\end{align}
One optimizes the flow by minimizing the forwards KL-divergence between the true and the approximated distribution, which as discussed in~\ref{subsubsec:meas_IT} is equivalent to minimizing the NLL:
\begin{align}
