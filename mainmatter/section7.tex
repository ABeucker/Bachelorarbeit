...
\green{I have recalculated my results and am currently rewriting this section. Results will be different (and better!)}

\green{Procedure, while I am still rewriting this section:}

\green{For each model, get all values log p(labels|summary) for the test set}

\green{I have trained separate models for p(labels), these will be considered as well}

\green{Bit within a given seed, the conditinoal entropy of log p(labels|summary) should hopefully increase already}
