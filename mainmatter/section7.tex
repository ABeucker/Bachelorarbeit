...
\green{I have recalculated my results and am currently rewriting this section. Results are much better. I see increase in mutual information, though not too significant. I was making mistakes in the error calculations though.}
...
Each model was trained for 250 epochs, with an average runtime of \red{insert average runtime}. Due to these training times, only specific bottleneck dimensions were analyzed. A number of bottleneck dimensions as well as a number of different weight initializations (seeds) were tested.
